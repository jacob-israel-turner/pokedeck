...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactAddonsUpdate = __webpack_require__(225);
	...
	var App = function (_Component) {
	  ...
	  _createClass(App, [{
	    key: 'editPokemon',
	    value: function editPokemon(index, changes) {
	      this.setState((0, _reactAddonsUpdate2.default)({ pokemon: _defineProperty({}, index, { $set: changes }) }));
	    }
	  }, {
	    key: 'passPropsToRoute',
	    value: function passPropsToRoute(routes) {
	      var props = {
	        pokemon: this.state.pokemon,
	        editPokemon: this.editPokemon
	      };
	      return routes && _react2.default.cloneElement(routes, props);
	    }
	  }, {
	    key: 'render',
	...
	_reactDom2.default.render(_react2.default.createElement(
	  ...
	  _react2.default.createElement(
	    ...
	    _react2.default.createElement(_reactRouter.Route, { path: 'pokemon/:id', component: _components.Pokemon })
	  )
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Pokemon = exports.PokemonPreview = exports.Header = exports.Home = undefined;
	...
	var _pokemonPreview = __webpack_require__(230);

	var _pokemonPreview2 = _interopRequireDefault(_pokemonPreview);

	var _pokemon = __webpack_require__(231);
	...
	exports.PokemonPreview = _pokemonPreview2.default;
	exports.Pokemon = _pokemon2.default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Home = function Home(props) {
	  return _react2.default.createElement(
	    ...
	    props.pokemon.map(function (data, index) {
	      return _react2.default.createElement(_index.PokemonPreview, _extends({ id: index, key: data.nickname + data.species }, data));
	    })
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PokemonPreview = function PokemonPreview(props) {
	  console.log(props);
	  return _react2.default.createElement(
	    'div',
	    { style: styles.container },
	    _react2.default.createElement('img', { style: styles.pic, src: props.pic }),
	    _react2.default.createElement(
	      'div',
	...
	exports.default = PokemonPreview;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Pokemon = function (_Component) {
	  ...
	  function Pokemon() {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Pokemon).call(this));
	  ...
	  _createClass(Pokemon, [{
	    ...
	    value: function toggleEdit() {
	      var pokemon = this.props.pokemon[this.props.params.id];
	      this.setState(_extends({ isEditing: !this.state.isEditing }, pokemon));
	    }
	  }, {
	    key: 'handleChange',
	    ...
	    value: function render() {
	      ...
	      if (!this.state.isEditing) {
	        ...
	        bio = _react2.default.createElement(
	          'div',
	          { style: styles.infoContainer },
	          _react2.default.createElement('input', { type: 'text', onChange: this.handleChange.bind(this, 'nickname'), value: this.state.nickname }),
	          _react2.default.createElement('br', null),
	          _react2.default.createElement('input', { type: 'text', onChange: this.handleChange.bind(this, 'gender'), value: this.state.gender }),
	          _react2.default.createElement('input', { type: 'text', onChange: this.handleChange.bind(this, 'species'), value: this.state.species })
	        );
	      }
	      return _react2.default.createElement(
	        'div',
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement('img', { style: styles.pic, src: pokemon.pic }),
	          bio
	        ),
	        _react2.default.createElement(
	          'div',
	          ...
	          _react2.default.createElement(
	            'a',
	            { href: '#', onClick: this.toggleEdit.bind(this) },
