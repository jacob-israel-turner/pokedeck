...
/***/ function(module, exports, __webpack_require__) {
	...
	var _pokemonPreview = __webpack_require__(255);

	var _pokemonPreview2 = _interopRequireDefault(_pokemonPreview);

	var _pokemon = __webpack_require__(256);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function reducer() {
	  ...
	  switch (action.type) {
	    case 'UPDATE':
	      return (0, _reactAddonsUpdate2.default)(state, { pokemon: _defineProperty({}, action.index, { $set: action.changes }) });
